 ...
 */
/*
    * The program does NOT require you surrender your instagram username and password.
...
public class Tool {
    ...
    /**
     * The following method parses the JSON file and creates a list of the users following.
    ...
    /**
     * The following method parses the JSON file and creates a list of the users followers.
    ...
    public static ArrayList<String> notFollowBack(ArrayList<String> following, ArrayList<String> followers) {
        ...
        for (int i = 0; i < following.size(); i++) {
            ...
            for (int j = 0; j < followers.size(); j++) {
                if (following.get(i).equals(followers.get(j))) {
                    flag = true; //they follow you black
                }
            }
            if (!flag) {
                answer.add(following.get(i));
            }
        }
        return answer;
    }
    ...
    /**
     * The following method writes the data in the list to a text file for the user to have.
